...
public class EffAddExp extends Effect {
	...
	protected void execute(Event e) {
		...
		try {
			...
			SkillAPI.getPlayerData(p).giveExp(amount, source);
			
		} catch (NullPointerException ex) {
			
			Skript.warning("[SkRPG] Error: NPE at adding experience to class. Did the player have a class in the first place?");
			return;
		}
	}
}
